...
ggplot(summary_data, aes(x = FoodGroup, y = count, fill = factor(intake_level, 
    levels = c("High", "Medium", "Low", "None")))) +  # Flipping order
  geom_bar(stat = "identity") +
  scale_fill_manual(values = c(
    "High" = "#e5a64a",    # Soft Yellow/Gold
    "Medium" = "#79a84a",  # Subdued Green
    "Low" = "#5a9ec7",     # Muted Teal/Blue-Green
    "None" = "#1f4e79"     # Deep Blue
  )) +
